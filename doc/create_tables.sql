...
CREATE TABLE "list" (
  ...
  -- pour avoir la date et l'heure on utilise le type "timestamp"
  -- pour être le plus précis possible on utilisera plutôt le type "timestampz" 
  -- qui contient en plus de la date et de l'heure le fuseau horaire défini dans les locales du serveur
